...
export default function Experience() {
  return (
    <section id="experience" className="relative py-32 px-6 section-grid section-blob-right overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-20 right-[10%] w-72 h-72 rounded-full bg-gradient-to-br from-indigo-500/10 to-violet-500/10 dark:from-indigo-500/[0.02] dark:to-violet-500/[0.02] blur-3xl animate-orb-float" />
      <div className="pointer-events-none absolute bottom-32 left-[5%] w-56 h-56 rounded-full bg-gradient-to-tr from-violet-500/8 to-indigo-500/8 dark:from-violet-500/[0.01] dark:to-indigo-500/[0.01] blur-3xl animate-orb-float-reverse" />
